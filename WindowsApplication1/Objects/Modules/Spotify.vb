...
Namespace  Objects.Modules
    Public Class Spotify
        ...
        Public Sub New()
            ...
            '_spotify.OnPlayStateChange.Method(OnPlayerStateChanged())
        ...
        Public Sub AdEnded() Implements IAdModule.AdEnded
            ...
            If Not SpotifyUp Then Initialize()
            _spotify.Pause()
        End Sub
        ...
        Public Sub OnPlayerStateChanged(sender As Object, e As PlayStateEventArgs)
