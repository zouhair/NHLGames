...
Public Class WatchGameControl
    ...
    Private Sub SetEventArgsFromForm()
        ...
        If rbMPC.Checked Then
            WatchArgs.PlayerPath = FileAccess.LocateEXE("mpc-hc64.exe", "\MPC-HC")
            WatchArgs.PlayerType = GameWatchArguments.PlayerTypeEnum.MPC
        Else
            WatchArgs.PlayerPath = FileAccess.LocateEXE("vlc.exe", "\VideoLAN\VLC")
    ...
    Private Sub MetroButton1_Click(sender As Object, e As EventArgs) Handles btnWatch.Click
    ...
    Private Sub LinkLabel1_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkVLCDownload.Click
        Dim sInfo As ProcessStartInfo = New ProcessStartInfo("http://www.videolan.org/vlc/download-windows.html")
        Process.Start(sInfo)
    End Sub

    Private Sub lnkMPCDownload_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles lnkMPCDownload.Click
    ...
    Private Sub WatchGameControl_Load(sender As Object, e As EventArgs) Handles Me.Load
        'InitializeComponent()
        'btnWatch.Focus()
        '' Add any initialization after the InitializeComponent() call.
